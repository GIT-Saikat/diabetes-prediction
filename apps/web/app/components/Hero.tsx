...
const Hero = ({ onCreateAccount, onSignIn }: HeroProps) => {
  return (
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <p className="text-gray-600 text-lg">
            Get a comprehensive diabetes risk assessment based on your health
            metrics. Our intelligent system analyzes multiple factors to provide
            personalized insights and actionable recommendations for better
            health.
          </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Evaluate multiple health factors including glucose, BMI, blood
                  pressure, family history, and more for accurate risk
                  assessment.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Receive tailored recommendations and actionable feedback based
                  on your unique health profile and risk factors.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Get clear risk levels (Low, Moderate, High, Very High) with
                  detailed explanations of factors contributing to your diabetes
                  risk.
                </p>
              </div>
            </div>
